...
void Init_Port3(void){ // Configure PORT 3
    //------------------------------------------------------------------------------
     P3OUT = 0x00; // P4 set Low
     P3DIR = 0x00; // Set P4 direction to output
...
void Init_Port5(void){ // Configure PORT 5
    //------------------------------------------------------------------------------
     P5OUT = 0x00; // P4 set Low
     P5DIR = 0x00; // Set P4 direction to output
...
void Init_Port6(void){ // Configure PORT 6
    //------------------------------------------------------------------------------
     P6OUT = 0x00; // P4 set Low
     P6DIR = 0x00; // Set P4 direction to output
     ...
     P6SEL1 &= ~L_FORWARD;
     P6OUT &= ~L_FORWARD;
     P6DIR |= L_FORWARD; // set to output for project 3
