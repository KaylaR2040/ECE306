...
extern volatile char website1;
extern volatile char website2;
...
//        UCA1IE |= UCTXIE;         // Enable Tx interrupt
    ...
    case 4:{                                         // Vector 4 - TXIFG
        ...
        // UCA1TXBUF = iot_TX_buf[tx_index];
        // iot_TX_buf[tx_index++] = 0x00;
        // if(iot_TX_buf[tx_index] == 0x00){
        //     UCA0IE &= ~UCTXIE;
        //     tx_index = 0;
        //     transmit_done = 1;
        //     clear_display = 0;
...
//        P6OUT ^= GRN_LED;
        if(ping){
            strcpy(IOT_Ring_Rx, website1);
            UCA1IE |= UCTXIE;
            prevping = ping;
        }
        else{
//            strcpy(IOT_Ring_Rx, website2);
//            UCA1IE |= UCTXIE;
//            prevping = ping;
        }
    }
