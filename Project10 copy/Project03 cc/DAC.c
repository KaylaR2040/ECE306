...
// File: DAC.C
//
// Description:  file for DAC (Digital-to-Analog Converter) configuration
//              for the MSP430FR235x microcontroller. Contains function 
//              declarations and relevant macros.
//
// Date: 11-10-24
